    ...
    <div className="bg-white">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-sm sm:prose max-w-none text-gray-700">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. No Somos Profesionales Médicos</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">6. Garantía de No Responsabilidad</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">11. Publicidad y Enlaces a Terceros</h2>
          <p>
