      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10 text-center py-20">
          <div className="space-y-8 animate-fadeIn">
            {/* Headline */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-600 tracking-tight">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 md:gap-20">
            <div className="text-center">
              ...
              <p className="text-gray-600">Генера tu rutina</p>
            </div>
            <div className="text-center">
      ...
      <section className="py-20 md:py-32 bg-gray-50 border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10">
          ...
          <div className="text-center mt-12">
            <Link
              href="/rutinas"
              className="inline-block px-8 py-3 text-black font-500 hover:underline text-lg"
            >
